...
typedef struct {                /* --- table reader --- */
  ...
  int   rec;                    /* number of current record */
  int   pos;                    /* number of current field */
...
extern int      trd_len    (TABREAD *trd);
extern int      trd_last   (TABREAD *trd);
extern int      trd_delim  (TABREAD *trd);
extern int      trd_rec    (TABREAD *trd);
extern int      trd_pos    (TABREAD *trd);
